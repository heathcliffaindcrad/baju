            ...
            <div>
                ...
                <p class="text-muted mb-0">
                    @if($notifications->where('is_read', false)->count() > 0)
                        Anda memiliki {{ $notifications->where('is_read', false)->count() }} notifikasi belum dibaca
                    @else
        ...
        <div class="card-modern">
            <div class="card-body p-0">
                @forelse($notifications as $notification)
                    <div class="notification-item d-flex justify-content-between align-items-start p-4 {{ !$loop->last ? 'border-bottom' : '' }} {{ !$notification->is_read ? 'notification-unread' : '' }}">
