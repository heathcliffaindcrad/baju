...
<head>
    ...
    <title>{{ $settings->store_name }} - Fashion Store</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-landing">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                <i class="bi bi-bag-heart-fill"></i> {{ $settings->store_name }}
            </a>
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    @auth
                        <li class="nav-item ms-2">
                            <a class="btn btn-landing" href="{{ route('home') }}">
                    ...
                    @else
                        ...
                        <li class="nav-item ms-2">
                            <a class="btn btn-landing" href="{{ route('register') }}">
                ...
                <div class="col-lg-6 hero-content">
                    @if($settings->promo_text)
                        <div class="promo-badge">
                            <i class="bi bi-megaphone-fill me-2"></i>{{ $settings->promo_text }}
                        </div>
                    @endif
                    <h1 class="hero-title">
                    ...
                    <p class="hero-subtitle">
                        ...
                        Tampil stylish setiap hari bersama {{ $settings->store_name }}.
                    </p>
                    <div class="d-flex gap-3 flex-wrap">
                        <a href="{{ route('products.index') }}" class="btn btn-hero btn-hero-primary">
            ...
            <div class="row g-4">
                @foreach($categories as $index => $category)
                    <div class="col-lg-3 col-md-4 col-6">
                        <a href="{{ route('products.index', ['category' => $category->id]) }}" class="category-card animate-fadeInUp" style="animation-delay: {{ $index * 0.1 }}s">
    ...
    <section class="products-section" id="products">
        <div class="container">
            ...
            <div class="row g-4">
                @foreach($featuredProducts as $index => $product)
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="product-card h-100 animate-fadeInUp" style="animation-delay: {{ $index * 0.05 }}s">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="mt-auto">
                                    ...
                                    <a href="{{ route('products.show', $product) }}" class="btn btn-modern-primary w-100">
            ...
            <div class="text-center mt-5">
                <a href="{{ route('products.index') }}" class="btn btn-modern-primary btn-lg">
    ...
    <section class="cta-section">
        <div class="container">
            ...
            @else
                <a href="{{ route('products.index') }}" class="btn btn-hero btn-hero-primary btn-lg">
    ...
    <footer class="footer-landing">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4">
                    <h5><i class="bi bi-bag-heart-fill me-2"></i>{{ $settings->store_name }}</h5>
                    <p>{{ $settings->store_description ?? 'Toko fashion online terpercaya dengan koleksi terlengkap dan harga terbaik.' }}</p>
                ...
                <div class="col-lg-3 col-md-4">
                    <h5>Kontak</h5>
                    <ul class="footer-links">
                        <li><i class="bi bi-geo-alt me-2"></i>{{ $settings->store_address }}</li>
                        <li><i class="bi bi-telephone me-2"></i>{{ $settings->store_phone }}</li>
                        <li><i class="bi bi-envelope me-2"></i>{{ $settings->store_email }}</li>
                    </ul>
                </div>
            </div>
            <hr class="my-4" style="border-color: rgba(255,255,255,0.1);">
            <div class="text-center">
                <p class="mb-0">&copy; {{ date('Y') }} {{ $settings->store_name }}. All rights reserved.</p>
            </div>
        </div>
    </footer>
