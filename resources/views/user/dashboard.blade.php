        ...
        <div class="card-modern p-4" style="background: var(--primary-gradient); color: white;">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0 opacity-75">Selamat datang kembali, {{ $user->full_name ?? $user->username }}!</p>
                </div>
        ...
        <div class="stat-card-modern gradient-1">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h3 class="mb-0">{{ $user->transactions->count() }}</h3>
                </div>
        ...
        <div class="stat-card-modern gradient-2">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h3 class="mb-0">{{ $user->transactions->where('status', 'completed')->count() }}</h3>
                </div>
        ...
        <div class="stat-card-modern gradient-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h3 class="mb-0">{{ count(session('cart', [])) }}</h3>
                </div>
    ...
    <div class="col-12">
        <div class="card-modern">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-3 col-6">
                        <a href="{{ route('home') }}" class="btn btn-modern btn-modern-primary w-100 py-3">
                            <i class="bi bi-bag-heart fs-4 d-block mb-1"></i>
                            Katalog Produk
                        </a>
                    </div>
                    <div class="col-md-3 col-6">
                        <a href="{{ route('cart.index') }}" class="btn btn-outline-primary w-100 py-3" style="border-radius: 12px;">
                    ...
                    <div class="col-md-3 col-6">
                        <a href="{{ route('transactions.index') }}" class="btn btn-outline-success w-100 py-3" style="border-radius: 12px;">
                            <i class="bi bi-receipt fs-4 d-block mb-1"></i>
                            Pesanan Saya
                        </a>
                    </div>
                    <div class="col-md-3 col-6">
                        <a href="{{ route('notifications.index') }}" class="btn btn-outline-warning w-100 py-3" style="border-radius: 12px;">
...
{{-- Recent Transactions & Profile --}}
<div class="row">
    <div class="col-md-8">
        <div class="card-modern">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="bi bi-clock-history"></i> Transaksi Terbaru</h5>
                <a href="{{ route('transactions.index') }}" class="btn btn-sm btn-outline-primary" style="border-radius: 20px;">
                    Lihat Semua
                </a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @forelse($recent_transactions as $transaction)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('transactions.show', $transaction) }}" class="btn btn-sm btn-outline-primary" style="border-radius: 8px;">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </td>
                                </tr>
            ...
            <div class="card-body">
                ...
                <table class="table table-sm table-borderless mb-3">
                    <tr>
                        ...
                        <td class="fw-bold text-end">{{ $user->username }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="fw-bold text-end">{{ Str::limit($user->address ?? '-', 20) }}</td>
                    </tr>
                    <tr>
                        <td class="text-muted"><i class="bi bi-calendar"></i> Bergabung</td>
                        <td class="fw-bold text-end">{{ $user->created_at->format('d M Y') }}</td>
                    </tr>
                </table>
                <a href="{{ route('profile') }}" class="btn btn-modern btn-modern-primary w-100">
